                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{ asset('img/' . $product->image) }}" alt="Image">
                        </div>
                ...
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        <div class="text-primary mr-2">
                            @php
                                $roundedRating = round($averageRating * 2) / 2; // Round to the nearest 0.5
                            @endphp
                            @for ($i = 1; $i <= 5; $i++)
                                @if ($i <= $roundedRating)
                    ...
                    <p class="mb-4">{!! nl2br(e(str_replace('-', "\n-", $product->short_description))) !!}</p>
                    {{-- <div class="d-flex mb-3">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            <div class="input-group-btn">
                                <button class="btn btn-primary btn-minus" data-id="{{ $product->id }}">
                                    <i class="fa fa-minus"></i>
                                </button>
                            </div>
                            <input type="text" class="form-control bg-secondary border-0 text-center" value="1">
                            <div class="input-group-btn">
                                <button class="btn btn-primary btn-plus" data-id="{{ $product->id }}">
                                    <i class="fa fa-plus"></i>
                                </button>
                            </div>
                        </div>
                        <button class="btn btn-primary px-3" data-id="{{ $product->id }}"><i
            ...
            <div class="col">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        <a class="nav-item nav-link text-dark active" data-toggle="tab" href="#tab-pane-1">Thông số kĩ
                            thuật</a>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            <h4 class="mb-3">Thông số kĩ thuật</h4>
                            @php
                                    ...
                                    @foreach ($reviews as $item => $review)
                                        <div class="media mb-4">
                                            ...
                                            <div class="media-body">
                                                <h6>{{ $reviewNames[$item] }}<small> -
                                                        <i>{{ $review->created_at }}</i></small></h6>
                                                <div class="text-primary mb-2">
                                                    @php
                                                        $rating = $review->rating;
                                                        $roundedRating = round($rating * 2) / 2; // Làm tròn đến 0.5 gần nhất
                                                    @endphp
                                                    @for ($i = 1; $i <= 5; $i++)
                                                        @if ($i <= $roundedRating)
